...
| Keyframe execution | Twelve selected anchors: six GPT Image 2 high/2k corrections at 42 gross credits, four deterministic transition anchors at zero cost, and accepted KF-06 desktop v4/mobile v5 resolves; earlier successful exploratory/control/poster/revision batches spent 50.92 credits | Exploratory/control/revision assets remain private, are not Soul inputs or public delivery assets, and have separate private records. Exact private binaries and fingerprints remain outside Git. |
| Motion execution | Eight successful silent Seedance 2.0 start/end segments: four 16:9 desktop and four 9:16 mobile, each 5 seconds at 1080p standard/high-bitrate and 45 credits | All eight passed structural and contact-sheet visual review. One failed mobile resort-reveal attempt for VID-RST-M-001 was fully refunded; one bounded replacement passed. |
...
| Paid-credit generation | EXECUTED FOR APPROVED PREVIEW ASSET WORK | 25 training + 0.84 diagnostics + 50.92 private exploratory/control/revision + 42 keyframe correction + 360 successful motion = 478.76 successful spend. Total charged was 523.76 including one fully refunded 45-credit failure; concurrent 10-credit reward remains recorded separately. |
